    ...
    <div class="registration__content">
      <div class="registration__content__info">
        <div class="registration-content-block">
          ...
          <input v-model="formData.password_confirmation" type="password" placeholder="Repeat password" class="form__field">
          <div class="sign__block">
            <button @click="register" class="form__btn">Register</button>
            <p class="form__text">Already registered??  <router-link to="/authorization">Sign In</router-link></p>
          </div>
        </div>
